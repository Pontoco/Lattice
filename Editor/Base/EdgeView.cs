...
namespace Lattice.Editor.Views
{
    ...
    public sealed class EdgeView : Edge
    {
        ...
        // Weirdly, this is private on the base Edge.
        protected BaseGraphView GraphView => GetFirstAncestorOfType<BaseGraphView>();
        ...
        {
            styleSheets.Add(
                AssetDatabase.LoadAssetAtPath<StyleSheet>("Packages/com.pon.lattice/Editor/UI/EdgeView.uss"));
        }
