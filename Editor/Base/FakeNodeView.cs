...
namespace Lattice.Editor.Views
{
	...
	internal sealed class FakeNodeView : GraphElement
	{
		...
		public FakeNodeView(BaseNodeView node)
		{
			...
			root = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.pon.lattice/Editor/UI/FakeNodeView.uxml").Instantiate()[0];
            styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>("Packages/com.pon.lattice/Editor/UI/TooltipView.uss"));
            Add(root);
			...
			subtitle.style.display = nodeSubtitle.resolvedStyle.display;
