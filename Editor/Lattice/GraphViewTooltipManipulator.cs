    ...
    public partial class LatticeGraphView
    {
        ...
        private sealed class GraphViewTooltipManipulator : Manipulator
        {
            ...
            private sealed class TooltipProvider : IEquatable<TooltipProvider>
            {
                ...
                private IHasGraphTooltip graphTooltipElement;

                public void Update(TooltipProvider other)
                {
                    Tooltip = other.Tooltip;
                    Element = other.Element;
                    graphTooltipElement = other.graphTooltipElement;
                }

                public void Update(IHasGraphTooltip target)
                {
                    graphTooltipElement = target;
                    Element = graphTooltipElement as VisualElement;
                ...
                public void Update(VisualElement target)
                {
                    ...
                    if (graphTooltipElement == newGraphTooltipElement)
                    {
                        return;
                    }

                    Element = (VisualElement)newGraphTooltipElement;
                    graphTooltipElement = newGraphTooltipElement;
                    Tooltip = graphTooltipElement.Tooltip;
                }
                ...
                public bool Equals(TooltipProvider other)
                {
                    ...
                    return Equals(graphTooltipElement, other.graphTooltipElement) && Tooltip == other.Tooltip && Equals(Element, other.Element);
                }
            }
                ...
                where TTarget : VisualElement, IHasGraphTooltip
            {
                root?.Query<TTarget>().ForEach(e =>
                {
                    if (show)
                    {
                        tempTooltipProvider.Update((IHasGraphTooltip)e);
